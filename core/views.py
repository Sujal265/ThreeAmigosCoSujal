...
from core.models import  Address, Product, Category, Vendor, CartOrder, CartOrderItems, ProductReview,  wishlist_model
...
def filter_product(request):
    ...
    # min_price = request.GET['min_vendor_price']
    # max_price = request.GET['max_vendor_price']
